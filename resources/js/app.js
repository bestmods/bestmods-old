    ...
    var table = $('#mods').DataTable({
        ...
        "columnDefs": [
            ...
            },
            {
                targets: 12,
                "render": function ( data, type, row, meta ) {
                    return '<div class="card-buttons text-center"><a href="' + row[9] + '" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Original</a></div>';
                  }
            }
        ]
    });
